                    ...
                    <div class="col-xl-6">
                        <div class="text-center text-white">
							...
							<?php	
								...
								echo "<form method='POST' action='testname.php'> <select name='Rtestname' class='form-select form-select-sm' aria-label='.form-select-sm example'>";
								...
								echo "</select><input style = 'padding: 0.25rem 1rem;' class='btn btn-outline-warning ' type='submit' value='開始' /> </form> ";
